(function( $ ) {
    ...
    $("body").on("mouseover",".digital-lab-slider .digital-lab-slide-content", function() {
        //Clear the Interval
        clearInterval(myInterval);
        $('.digital-lab-slider').find('.digital-lab-slide-progress svg path').css('animation-play-state', 'paused');
    });

    $("body").on("mouseleave",".digital-lab-slider .digital-lab-slide-content", function() {
        //Clear the Interval
        clearInterval(myInterval);
        //Set new Interval
        myInterval = setInterval(function () {
        ...
        // $('.digital-lab-slider').find('.digital-lab-slide-progress svg path').css('animation-play-state', '');
        add_slide_progress();
    });
