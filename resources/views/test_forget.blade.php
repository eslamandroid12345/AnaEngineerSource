...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('dashboard')}}app-assets/images/logo/favicon.svg">
...
<!-- BEGIN: Theme JS-->
<script src=" {{asset('dashbord/app-assets/js/core/app-menu.j')}}"></script>
