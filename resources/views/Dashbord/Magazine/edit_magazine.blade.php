                ...
                <div class="row">
                    <form method="POST" action="{{route('Magazine.edit',$magazine->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                ...
                                <input type="text" class="form-control font" id="basicInput"
                                       value="{{old('title') ?? $magazine->title}}"  name="title" required>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                <label class="form-label font" for="basicInput">عنوان المجله </label>
                                <input type="text" class="form-control font" id="basicInput"
                                       value="{{old('slug') ?? $magazine->slug}}"  name="slug" required>
                            </div>
                        </div>
                        <div class="mb-1">
                        ...
                        <div class="input-group mb-3 color">
                            ...
                            <img src="{{asset('magazine/'.$magazine->photo)}}" alt="img" class="gallery-thumb-img" style="height: 300px; width: 100%">
