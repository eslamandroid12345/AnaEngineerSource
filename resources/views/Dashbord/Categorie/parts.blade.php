...
<!-- END: Main Menu-->
    ...
    <div class="app-content content ">
       ...
       <a href="{{route('parts.create')}}"> <button type="button"  class="btn btn-success waves-effect waves-float waves-light align-items-start fontSize " >+
        ...
        <a href="{{route('article.index')}}"> <button type="button" class="btn btn-danger waves-effect waves-float waves-light align-items-start fontSize">
                عرض المقالات</button></a>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end font">
                                            ...
                                            <form action="{{ route('parts.destroy', $Category->id) }}" method="POST" onsubmit="return confirm('حذف القسم سيؤدي الي حذف جميع المقالات التابعه لها ')">
                                                @csrf
                                                @method('DELETE')
