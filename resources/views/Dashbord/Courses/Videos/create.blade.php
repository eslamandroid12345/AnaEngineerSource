    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title font">بيانات الفيديو</h4>
            </div>
                ...
                <form method="POST" action="{{route('video.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                <label class="form-label font" for="basicInput">الأسم</label>
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            ...
                            <label class="form-label font" for="basicSelect">القسم</label>
                        ...
                        <div class="input-group mb-3 color">
                            <label class="input-group-text font color" for="inputGroupFile01">اختر الفيديوهات</label>
