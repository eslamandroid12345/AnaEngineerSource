...
<div class="app-content content ">
    ...
    <!-- END: Content-->
    @include('alerts')
    <h5 class="mb-1 fontBig">الفيديوهات </h5>
    ...
    <a href="{{route('video.create')}}"> <button type="button" class="btn btn-success waves-effect waves-float waves-light align-items-start fontSize">+
            اضف فيديو</button></a>
    <a href="{{route('course.index')}}"> <button type="button" class="btn btn-success waves-effect waves-float waves-light align-items-start fontSize">
            عرض الدورات</button></a>
    <a href="{{route('section.index')}}"> <button type="button" class="btn btn-success waves-effect waves-float waves-light align-items-start fontSize">
            عرض الأقسام</button></a>
                            ...
                            <td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <form action="{{ route('video.destroy', $video->id) }}" method="POST" onsubmit="return confirm('هل متأكد من حذف الفيديو ؟ ')">
                                            @csrf
                                            @method('DELETE')
