                ...
                <form method="POST" action="{{route('article.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            ...
                            <select class="form-select font"  id="basicSelect" name="category" required>
