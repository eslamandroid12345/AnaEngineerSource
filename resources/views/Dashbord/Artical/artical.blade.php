...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static   menu-collapsed" data-open="click"
    ...
    <div class="app-content content ">
       ...
       <a href="{{route('article.create')}}"> <button type="button" class="btn btn-success waves-effect waves-float waves-light align-items-start fontSize">+
            اضف مقاله</button></a>
        <a href="{{route('parts.index')}}"> <button type="button" class="btn btn-danger waves-effect waves-float waves-light align-items-start fontSize">
                 عرض الاقسام</button></a>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <form action="{{ route('delete.article', $article->id) }}" method="POST" onsubmit="return confirm('هل متأكد من حذف المقاله ؟')">
                                                @csrf
                                                @method('DELETE')
